...
export const RAZORPAY_PROXY_URL = optionalEnv(
  'VITE_RAZORPAY_PROXY_URL',
  '/functions/v1/razorpay-proxy'
);
export const RESEND_API_KEY = optionalEnv('RESEND_API_KEY', '');
export const EXCHANGE_RATE_API_KEY = optionalEnv('VITE_EXCHANGE_RATE_API_KEY', '');
