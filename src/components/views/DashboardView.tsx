...
import GoalsSummary from '@/components/features/dashboard/GoalsSummary';
import DailyStats from '@/components/features/dashboard/DailyStats';
import { SafeToSpend } from '@/components/features/dashboard/SafeToSpend';
import { SpendWiseConfig } from '@/components/features/onboarding/OnboardingModal';
import { useIsMobile } from '@/hooks/useMediaQuery';
import DashboardViewMobile from '@/components/views/DashboardViewMobile';

// Lazy load non-critical/heavy components
const FinanceChartLazy = lazy(() => import('@/components/features/dashboard/FinanceChart'));
const WealthCity = lazy(() => import('@/components/features/gamification/WealthCity'));
const QuestsPanel = lazy(() => import('@/components/features/gamification/QuestsPanel').then(m => ({ default: m.QuestsPanel })));
const SavingsChallenges = lazy(() => import('@/components/features/gamification/SavingsChallenges').then(m => ({ default: m.SavingsChallenges })));
const RoundUpVault = lazy(() => import('@/components/features/gamification/RoundUpVault').then(m => ({ default: m.RoundUpVault })));
const SocialLeaderboard = lazy(() => import('@/components/features/gamification/SocialLeaderboard').then(m => ({ default: m.SocialLeaderboard })));
const PredictiveForecasting = lazy(() => import('@/components/features/analytics/PredictiveForecasting').then(m => ({ default: m.PredictiveForecasting })));
const StreakShareCard = lazy(() => import('@/components/features/gamification/StreakShareCard').then(m => ({ default: m.StreakShareCard })));
const WeeklyDigestCard = lazy(() => import('@/components/features/dashboard/WeeklyDigestCard').then(m => ({ default: m.WeeklyDigestCard })));
const QuickAddPanel = lazy(() => import('@/components/features/dashboard/QuickAddPanel'));
const PremiumCard = lazy(() => import('@/components/features/dashboard/PremiumCard'));
