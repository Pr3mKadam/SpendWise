    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/70 backdrop-blur-md animate-fade-in">
      <div className="bg-[var(--surface-card)] rounded-3xl w-full max-w-sm p-6 shadow-2xl animate-scale-in border border-[var(--teal)]/20 relative overflow-hidden">
        ...
        <div className="text-center mt-2 mb-6">
          ...
          <h3 className="font-manrope font-black text-lg text-[var(--text-primary)]">Install SpendWise</h3>
        ...
        <div className="space-y-5 mb-6">
          ...
          <div className="flex items-start gap-4 p-3 rounded-2xl bg-[var(--surface-input)] border border-[var(--border)]/40">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-[10px] text-[var(--text-muted)] mt-0.5">Find the share option in Safari's bottom navigation bar.</p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-4 p-3 rounded-2xl bg-[var(--surface-input)] border border-[var(--border)]/40">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-[10px] text-[var(--text-muted)] mt-0.5">Scroll down the action sheet menu to find this option.</p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-4 p-3 rounded-2xl bg-[var(--surface-input)] border border-[var(--border)]/40">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-[10px] text-[var(--text-muted)] mt-0.5">Tap the "Add" button in the upper-right corner of your screen.</p>
            </div>
          </div>
