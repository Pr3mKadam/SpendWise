...
declare module '@capacitor/push-notifications' {
  export const PushNotifications: {
    ...
    addListener(event: 'registration', callback: (data: { value: string }) => void): Promise<{ remove: () => void }>;
    addListener(event: 'pushReceived', callback: (data: Record<string, unknown>) => void): Promise<{ remove: () => void }>;
...
declare module '@capacitor-community/sms-retriever' {
  export const SMSRetriever: {
    ...
    addListener(event: string, callback: (data: { message: string }) => void): Promise<{ remove: () => void }>;
  };
}
