...
export function HistoryToolbar({
  ...
  const btnBase =
    'flex items-center gap-1.5 sm:gap-2 rounded-xl px-3 sm:px-4 py-2 sm:py-2.5 text-xs sm:text-sm font-semibold transition-colors';
  const cardBtn = {
      ...
      {typeof navigator !== 'undefined' && !!navigator.share && (
        <button
          ...
          style={{
            ...
            color: 'var(--premium)',
            fontFamily: 'var(--font-inter)',
            border: '1.5px solid var(--premium-glow)',
