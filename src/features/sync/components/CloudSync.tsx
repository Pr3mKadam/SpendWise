          ...
          >
            <div className="relative">
              ...
              <input
                ...
                className="w-full bg-[var(--surface-input)] border border-[var(--border)] rounded-xl pl-9 pr-4 py-2.5 text-sm text-[var(--text-primary)] font-inter outline-none focus:border-[var(--teal)] transition-colors"
              />
            </div>
            <div className="relative">
              ...
              <input
                ...
                onKeyDown={e => e.key === 'Enter' && handleAuth(mode === 'signup')}
                className="w-full bg-[var(--surface-input)] border border-[var(--border)] rounded-xl pl-9 pr-10 py-2.5 text-sm text-[var(--text-primary)] font-inter outline-none focus:border-[var(--teal)] transition-colors"
              />
              <button onClick={() => setShowPw(!showPw)} className="absolute right-3 top-1/2 -translate-y-1/2 text-[var(--text-muted)] bg-transparent border-none cursor-pointer p-0">
