      ...
      <div className="grid gap-4">
        {[
          ...
          },
          {
            ...
            sub: 'Sync your Razorpay developer keys',
            color: '#3395FF',
            bg: 'rgba(51,149,255,0.1)',
          },
          {
            id: 'csv',
            label: 'CSV Import',
            sub: 'Already integrated in sidebar',
            color: '#a78bfa',
          ...
          <button
            ...
            onClick={() =>
              !opt.disabled &&
              onSetView(
                opt.id as 'dashboard' | 'upi-link' | 'plaid-link' | 'rzp-link' | 'web3-link' | 'csv'
              )
            }
