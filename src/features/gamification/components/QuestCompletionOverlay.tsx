        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
          ...
          >
            ...
            <p className="text-[var(--text-muted)] font-medium mb-8">
              Amazing work! You've successfully completed this challenge and earned 500 wealth
              points. Your Wealth Tree is glowing!
            </p>
            ...
            <div className="mt-8 flex justify-center gap-2">
              {[1, 2, 3, 4, 5].map(i => (
                <Star
                  key={i}
                  size={16}
                  className="text-[var(--teal)] fill-[var(--teal)] animate-bounce"
