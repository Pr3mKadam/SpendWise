...
export function StreakShareCard({ streak, level, levelName, savingsRate, currency = '₹' }: Props) {
  ...
  const grade =
    streak >= 30 ? 'Diamond' : streak >= 14 ? 'Gold' : streak >= 7 ? 'Silver' : 'Bronze';
              ...
              <div className="relative z-10">
                ...
                <div className="flex items-center justify-center gap-2 mb-2">
                  ...
                  <span
                    ...
                    style={{ color: streakColor, fontFamily: 'var(--font-manrope)', lineHeight: 1 }}
                  >
                    {streak}
                  </span>
                </div>
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  >
                    ...
                    <p className="text-[length:var(--fs-overline)] font-semibold text-white/50 uppercase tracking-wider mt-0.5">
                      Level
                    </p>
                  ...
                  <div
                    ...
                    style={{ background: 'rgba(255,255,255,0.06)' }}
                  >
                    <p className="text-xl font-bold tabular-nums" style={{ color: '#14b8a6' }}>
                      {savingsRate}%
                    </p>
                    <p className="text-[length:var(--fs-overline)] font-semibold text-white/50 uppercase tracking-wider mt-0.5">
                      Savings Rate
                ...
                <p className="text-white/30 text-[length:var(--fs-overline)] mt-6">
                  Track smarter · spendwise.app
                </p>
              </div>
            </div>
