...
export function BillingView({ onPlanChange }: BillingViewProps) {
  ...
  return (
    <>
      <div className="card p-6 space-y-5">
        ...
        {subscriptionId && (
          <div className="text-xs" style={{ color: 'var(--text-muted)' }}>
            <p>
              Subscription ID: <span className="font-mono">{subscriptionId.slice(0, 20)}...</span>
            </p>
          </div>
        )}
      </div>
      ...
      {showModal && (
        <SubscriptionBillingModal onClose={() => setShowModal(false)} onPlanChange={onPlanChange} />
      )}
        ...
        <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4">
          ...
          >
            ...
            <p className="text-sm mb-6" style={{ color: 'var(--text-muted)' }}>
              Downgrade to Free? You'll lose access to Pro features at the end of this billing
              period.
            </p>
