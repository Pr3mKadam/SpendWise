        ...
        {loading ? (
          ...
          >
            <div className="relative">
              ...
              <Brain
                size={20}
                className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-[var(--teal)]"
              />
            </div>
          ...
          >
            <div>
              <p className="text-[length:var(--fs-overline)] font-bold text-[var(--teal)] uppercase tracking-widest mb-1">
                Your Archetype
              </p>
            ...
            <div className="p-4 rounded-xl bg-gradient-to-br from-[var(--teal-dim)] to-transparent border border-[var(--teal)]/10">
              <div className="flex items-center gap-2 mb-2">
                ...
                <p className="text-[length:var(--fs-overline)] font-bold text-[var(--text-primary)] uppercase tracking-widest">
                  Growth Tip
                </p>
              </div>
