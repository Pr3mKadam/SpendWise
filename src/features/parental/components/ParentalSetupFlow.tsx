    ...
    <div className="max-w-2xl mx-auto p-4 animate-slide-up">
      {setupStep === 'welcome' && (
        <div className="card p-8 flex flex-col items-center text-center shadow-xl border border-[var(--teal)]/10">
          ...
          <h2 className="text-3xl font-extrabold text-[var(--text-primary)] mb-4 font-manrope">
            Parental Controls
          </h2>
          <p className="text-[var(--text-muted)] mb-10 text-lg max-w-md">
            Enable parental controls to monitor spending, approve high-value transactions, and
            manage chores.
          </p>
          <button
      ...
      {setupStep === 'pin' && (
        <div className="card p-8 flex flex-col items-center shadow-xl border border-[var(--teal)]/10">
          ...
          <h2 className="text-2xl font-bold text-[var(--text-primary)] mb-2 font-manrope text-center">
            Set Parental PIN
          </h2>
          ...
          <PinInput value={newPin} onChange={setNewPin} error={pinError} label="Create New PIN" />
          <button
          ...
          <div className="space-y-8">
            <div className="p-6 rounded-2xl bg-[var(--background-secondary)] border border-[var(--border-color)]">
              <div className="flex justify-between items-center mb-4">
                ...
                <span className="text-xl font-bold text-[var(--teal)] font-manrope">
