      ...
      {pendingTransactions.length === 0 ? (
        ...
        <div className="space-y-4">
          {pendingTransactions.map(t => (
            <div
              key={t.id}
              className="p-4 rounded-2xl bg-[var(--background-secondary)] border border-[var(--border-color)] hover:border-[var(--teal)]/30 transition-all"
            >
              <div className="flex justify-between items-start mb-4">
                ...
                <span className="text-xl font-bold text-[var(--text-primary)] font-manrope">
                  ${t.amount}
                </span>
              </div>
