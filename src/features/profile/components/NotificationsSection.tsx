      ...
      <div className="px-6 py-5 border-b border-[var(--border)] flex items-center justify-between">
        <div>
          ...
          <p className="text-xs text-[var(--text-muted)] mt-0.5">
            Stay updated with budget alerts and goal progress.
          </p>
        </div>
        ...
        <div className="flex items-center justify-between p-4 rounded-xl border border-[var(--border)] bg-[var(--surface-input)]">
          ...
          {notifPermission === 'default' && (
            <button
              ...
              className="px-4 py-2 bg-[var(--teal)] text-white text-xs font-bold rounded-lg transition-all active:scale-95"
            >
              Enable
            </button>
          )}
          {notifPermission === 'granted' && (
            <button
              ...
              className="px-4 py-2 bg-[var(--surface-card)] text-[var(--teal)] border border-[var(--teal)]/30 text-xs font-bold rounded-lg transition-all active:scale-95"
            >
              Test
            </button>
          )}
