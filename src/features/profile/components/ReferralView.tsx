...
export function ReferralView() {
  ...
  return (
    <div className="card p-6 space-y-5">
      <div>
        <h3 className="font-manrope font-bold text-base flex items-center gap-2" style={{ color: 'var(--text-primary)' }}>
      ...
      {referrals.length > 0 && (
        <div>
          <p className="text-xs font-bold mb-3 flex items-center gap-1" style={{ color: 'var(--text-muted)' }}>
            <Gift size={12} />
            Referred Friends
          </p>
      ...
      <div className="flex items-start gap-2 p-3 rounded-xl" style={{ background: 'var(--surface-input)' }}>
