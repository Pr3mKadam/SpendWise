...
function DataCard({
  ...
  return (
    ...
    >
      ...
      <h4
        className="font-inter font-bold text-[15px] mb-1"
        style={{ color: titleColor ?? 'var(--text-primary)' }}
      >
        {title}
      </h4>
      <p
        className="font-inter text-xs mb-4 flex-1"
    ...
    <div className="card">
      ...
      <div className="p-6 grid grid-cols-1 xl:grid-cols-2 gap-4">
        ...
        >
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              ...
              <p
                className="font-inter text-[length:var(--fs-overline)]"
                style={{ color: 'var(--teal)' }}
              >
                Professional Grade Security (AES-256)
              </p>
            </div>
          </div>
          <p
            ...
            style={{ color: 'var(--text-muted)', lineHeight: 1.6 }}
          >
            Export your entire SpendWise database (Transactions, Budgets, Quests, Goals, Portfolio)
            into a single encrypted file. The data is locked with your password and can only be
            decrypted by SpendWise.{' '}
          ...
          >
            <div className="flex items-center gap-3 mb-2">
              ...
              <h4
                ...
                style={{ color: 'var(--text-primary)' }}
              >
                Raw Database Export/Import (.json){' '}
                <span className="text-[10px] bg-indigo-500/20 text-indigo-400 px-1.5 py-0.5 rounded font-mono ml-2">
                  DEV ONLY
                </span>
              </h4>
            </div>
            <p className="font-inter text-xs mb-4" style={{ color: 'var(--text-muted)' }}>
              Export or import the raw IndexedDB database (unencrypted) for testing or moving to
        ...
        >
          ...
          <div className="flex gap-3 items-center">
            <label
              className="px-4 py-2 rounded-lg font-inter font-semibold text-xs transition-colors cursor-pointer"
              style={{
                background: 'var(--surface-card)',
                color: 'var(--text-primary)',
                border: '1.5px solid var(--border)',
