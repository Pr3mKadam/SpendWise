            ...
            >
              ...
              <div className="space-y-2">
                {suggestions.map((s: BudgetSuggestion) => {
                  const isApplied =
                    appliedSuggestions.has(s.category) ||
                    existingCategories.has(s.category as Category);
                  return (
                    <div
                      key={s.category}
                      className="flex items-center gap-3 rounded-xl px-3 py-2.5 transition-all"
                      style={{
                        background: isApplied ? 'rgba(20,184,166,0.06)' : 'var(--bg)',
                        border: `1px solid ${isApplied ? 'rgba(20,184,166,0.2)' : 'var(--border)'}`,
                      }}
                    >
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-2 mb-0.5">
                          ...
                          <span
                            ...
                            style={{
                              background: CONFIDENCE_COLOR[s.confidence] + '20',
          ...
          <div className="flex flex-wrap gap-3 items-end">
            ...
            <div className="flex gap-2">
              <button
                ...
                style={{
                  background:
                    !addCategory || !addLimit || parseFloat(addLimit) <= 0
                      ? 'var(--surface-input)'
                      : 'var(--teal)',
                  color:
                    !addCategory || !addLimit || parseFloat(addLimit) <= 0
        ...
        >
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              >
                Any unspent budget from the current period will automatically carry forward to the
                next one. Purple badges show how much was rolled over into each category.
              </p>
            </div>
          </div>
          <button
        ...
        >
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              >
                Switch between Weekly, Bi-Weekly, or Monthly periods above. Enable{' '}
                <strong>Rollover</strong> to carry unused budget into the next period automatically.
              </p>
            </div>
          </div>
          <button
