...
export function BudgetSummaryMobile({
  currency,
  totalBudgeted,
  overallBudgetPercent,
}: BudgetSummaryMobileProps) {
  return (
    <div className="bg-gradient-to-br from-[#0f172a] to-[#1e293b] rounded-[var(--radius-hero)] p-6 shadow-xl border border-white/5 relative overflow-hidden">
      ...
      <div className="relative z-10">
        <p className="text-[length:var(--fs-overline)] font-bold uppercase text-teal-400/80 tracking-[0.2em] mb-1">
        ...
        <div className="flex items-baseline gap-2">
          ...
          <span
            className={`text-[length:var(--fs-caption)] font-bold px-2 py-0.5 rounded-full ${overallBudgetPercent > 90 ? 'bg-red-500/20 text-red-400' : 'bg-teal-500/20 text-teal-400'}`}
          >
