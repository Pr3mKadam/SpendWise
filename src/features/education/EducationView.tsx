    ...
    <>
      ...
      <div className="animate-fade-in-up space-y-8 pb-20">
          ...
          <div className="relative z-10">
            <div className="flex flex-wrap items-start gap-8 mb-6">
              ...
              <div>
                ...
                <p className="font-manrope font-black text-4xl text-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="card p-5 bg-gradient-to-br from-teal-500/5 to-cyan-500/5 border-teal-500/10 flex items-start gap-4 h-full">
            ...
            <div>
              ...
              <p className="font-inter text-xs text-[var(--text-secondary)] leading-relaxed">
                {config?.userRole === 'student' ? (
                  <>
                    Since you're in the <strong>Student</strong> persona, we've prioritized{' '}
                    <strong>Debt Management</strong> and <strong>Budgeting</strong>. Avoid
                    high-interest credit card debt and build emergency savings early!
                  </>
                ) : config?.userRole === 'business' ? (
                  <>
                    Since you're in the <strong>Business Owner</strong> persona, we've prioritized{' '}
                    <strong>Tax Efficiency</strong> and <strong>Cash Flow</strong>. Master tax-loss
                    harvesting and optimize your working capital!
                  </>
                ) : (
                  <>
                    Your top spending category is <strong>{topCategory}</strong>. We recommend
                    starting with the{' '}
                    <button
                      onClick={() => setActiveLesson(LESSONS.find(l => l.id === 'l1')!)}
                      className="text-[var(--teal)] font-bold underline underline-offset-2 bg-transparent border-none cursor-pointer"
                    >
                      50/30/20 Rule
                    </button>{' '}
          ...
          <div
            className="card p-5 bg-gradient-to-br from-purple-500/5 to-fuchsia-500/5 border-purple-500/10 flex items-start gap-4 h-full cursor-not-allowed opacity-80"
          ...
          >
            ...
            <div>
              <div className="flex justify-between items-start mb-1">
                ...
                <span className="text-[length:var(--fs-overline)] font-bold uppercase tracking-wider bg-purple-500/10 text-purple-500 px-2 py-0.5 rounded-full shrink-0 ml-2">
                  Coming Soon
                </span>
              </div>
              <p className="font-inter text-xs text-[var(--text-secondary)] leading-relaxed mt-2">
                Test your skills in simulated environments like "Buying a Car" or "Market Crash".
                Earn massive XP for making the right choices under pressure.
              </p>
            </div>
          </div>
        </div>
            ...
            return (
              <button
                ...
                style={{
                  ...
                  cursor: 'pointer',
                  boxShadow:
                    filter === cat ? `0 4px 12px ${cfg?.color || 'var(--teal)'}30` : 'none',
                }}
              >
                {cfg?.icon}
        ...
        {completedRoleLessonsCount === roleLessons.length && (
          ...
          >
            ...
            <h3 className="font-manrope font-black text-2xl text-[var(--text-primary)] mb-2">
              Financial Scholar!
            </h3>
            <p className="font-inter text-sm text-[var(--text-secondary)]">
              You've completed all lessons for your active path. Your financial IQ has leveled up
              significantly.
            </p>
          </motion.div>
        )}
