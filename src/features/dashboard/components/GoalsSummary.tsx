    ...
    <Card style={{ padding: 18, height: '100%' }}>
      ...
      {goals.length === 0 ? (
        <div className="flex flex-col items-center justify-center py-6 px-2 text-center">
          ...
          <p className="text-[length:var(--fs-caption)] text-[var(--text-muted)] max-w-[160px]">
            ...
            return (
              <div key={g.id}>
                <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 6 }}>
                  ...
                  <span style={{ fontSize: 11, fontWeight: 700, color: g.color || '#6366f1' }}>
                    {pct}%
                  </span>
                </div>
                <div
                  style={{ height: 5, background: '#f1f3f9', borderRadius: 99, overflow: 'hidden' }}
                >
                  <div
                    style={{
                      height: '100%',
