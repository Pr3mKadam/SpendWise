      ...
      {recentTx.length === 0 ? (
        <div className="flex flex-col items-center justify-center py-10 px-4 text-center">
          ...
          <p className="text-xs text-[var(--text-muted)] max-w-[200px]">
            Add your first transaction using the Quick Add panel to get started.
          </p>
        </div>
      ) : (
          ...
          return (
            ...
            >
              ...
              <div
                ...
                style={{ background: bg }}
              >
                <span className="text-[length:var(--fs-caption)] font-bold text-white">
              ...
              <span
                ...
                style={{
                  ...
                  borderRadius: 20,
                  background:
                    tx.type === 'credit' ? 'rgba(16,185,129,0.1)' : 'rgba(248,113,113,0.1)',
