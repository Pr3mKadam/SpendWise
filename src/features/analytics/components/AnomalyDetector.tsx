    ...
    return (
      <div className="p-6 text-center">
        ...
        <p className="text-xs text-[var(--text-muted)]">
          Your spending patterns are consistent across all categories.
        </p>
      </div>
    );
  }
    ...
    <div className="space-y-4">
      ...
      <div className="p-4 rounded-2xl bg-blue-500/5 border border-blue-500/10">
        <p className="text-xs text-[var(--text-secondary)] leading-relaxed italic">
          "Tip: Anomalies are detected using Z-score analysis. If a transaction is more than 2
          standard deviations from the mean for that category, it's flagged."
        </p>
      </div>
    </div>
  );
