      ...
      <div className="flex items-start justify-between">
        <div>
          ...
          <p className="text-xs text-[var(--text-muted)] mt-1">
            Project your net worth growth over {years} years.
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="space-y-4">
            <div>
              <div className="flex flex-wrap justify-between items-end gap-1 mb-2">
                <label className="text-[length:var(--fs-overline)] font-bold text-[var(--text-muted)] uppercase tracking-wider">
                  Time Horizon
                </label>
            ...
            <div>
              <label className="text-[length:var(--fs-overline)] font-bold text-[var(--text-muted)] uppercase tracking-wider block mb-2">
                Initial Investment
              </label>
        ...
        <div className="lg:col-span-8 space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="p-4 rounded-xl bg-[var(--surface-input)] border border-[var(--border)]">
              <span className="text-[length:var(--fs-overline)] font-bold uppercase tracking-wider text-[var(--text-muted)] block mb-1">
                Total Contributions
              </span>
            ...
            <div className="p-4 rounded-xl bg-[var(--teal-dim)] border border-[var(--teal-dim)]">
              <span className="text-[length:var(--fs-overline)] font-bold uppercase tracking-wider text-[var(--teal)] block mb-1">
                Final Wealth
              </span>
        ...
        <div className="flex items-center gap-2 p-3 rounded-xl bg-blue-500/5 border border-blue-500/10 mt-4">
          ...
          <p className="text-[length:var(--fs-overline)] text-[var(--text-secondary)] leading-tight">
            This simulation uses the compound interest formula with monthly contributions. Actual
            market returns vary. Always consult with a human financial advisor before making large
