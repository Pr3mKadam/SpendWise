...
export function AddModal({ mode, currency, onAdd, onClose, config }: AddModalProps) {
      ...
      >
        ...
        >
          ...
          <div className="p-6 space-y-5">
            <div>
              <label
                className="block font-inter text-xs font-semibold uppercase tracking-wider mb-3"
              ...
              <div className="grid grid-cols-3 gap-2">
                {types.map(t => (
                  <button
                    ...
                    style={{
                      background:
                        selectedType === t.value ? t.color + '15' : 'var(--surface-input)',
                  ...
                  >
                    ...
                    <span
                      className="font-inter text-[length:var(--fs-caption)] font-semibold"
                      style={{ color: selectedType === t.value ? t.color : 'var(--text-muted)' }}
                    >
                      {t.label}
                    </span>
                  </button>
            ...
            <div>
              ...
              <input
                ...
                placeholder={
                  mode === 'asset'
                    ? 'e.g. HDFC Savings, Zerodha…'
                    : 'e.g. Car Loan, HDFC Credit Card…'
                }
            ...
            <div>
              ...
              <div className="relative">
                <span
                  className="absolute left-4 top-1/2 -translate-y-1/2 font-manrope font-bold text-lg"
                  style={{ color: 'var(--text-muted)' }}
                >
                  {currency}
                </span>
            ...
            {error && (
              <p className="font-inter text-xs font-semibold" style={{ color: 'var(--red)' }}>
                ⚠ {error}
              </p>
            )}
