  ...
  return (
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        <p
          className="font-inter font-semibold text-[14px] truncate"
        ...
        {simulatedTrend && (
          <div className="flex items-center gap-1 mt-0.5">
            <span
              className="text-[length:var(--fs-overline)] font-bold px-1.5 py-0.5 rounded"
              style={{
            ...
            <span
              className="text-[length:var(--fs-overline)] font-medium"
              style={{ color: 'var(--text-dim)', fontFamily: 'var(--font-inter)' }}
            >
              24h change
            </span>
          </div>
      ...
      <p
        className="font-manrope font-bold text-[16px] shrink-0 tabular-nums"
        style={{ color: 'var(--text-primary)' }}
      >
